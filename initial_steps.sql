...
UPDATE  verify.navigable_verify SET fc='1' WHERE fc LIKE'%motorway%' OR fc like'%trunk%';
UPDATE  verify.navigable_verify SET fc='2' WHERE fc LIKE'%primary%' OR fc like'%secondary%';
UPDATE  verify.navigable_verify SET fc='3' WHERE fc LIKE'%residential%' OR fc like'%tertiary%' OR fc like'%unclassified%' OR tags->'route'='ferry' OR fc like'%living_street%' OR fc like'%service%' OR fc like'%track%';
UPDATE  verify.navigable_verify SET fc='4' WHERE fc LIKE'%construction%' OR fc like'%proposed%';
...
UPDATE   public.navigable_current SET fc='1' WHERE fc LIKE'%motorway%' OR fc like'%trunk%';
UPDATE   public.navigable_current SET fc='2' WHERE fc LIKE'%primary%' OR fc like'%secondary%';
UPDATE   public.navigable_current SET fc='3' WHERE fc LIKE'%residential%' OR fc like'%tertiary%' OR fc like'%unclassified%' OR tags->'route'='ferry' OR fc like'%living_street%' OR fc like'%service%' OR fc like'%track%';
UPDATE   public.navigable_current SET fc='4' WHERE fc LIKE'%construction%' OR fc like'%proposed%';
