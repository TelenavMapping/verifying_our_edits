...
create table verify.no_name as (
select * from public.navigable_current where public.navigable_current.tags->'name' is null );

---
delete from verify.no_name where verify.no_name.tags->'highway'='motorway_link' or verify.no_name.tags->'highway'='trunk_link' or verify.no_name.tags->'highway'='primary_link' or
verify.no_name.tags->'highway'='secondary_link' or verify.no_name.tags->'highway'='tertiary_link' or verify.no_name.tags->'junction'='roundabout' or verify.no_name.tags->'highway'='service' or 
verify.no_name.tags->'highway'='track' or verify.no_name.tags->'highway'='road';

---
create table verify.deleted_name_tag as (
select * from verify.no_name where id in (select id from verify.navigable_verify where verify.navigable_verify.tags?'name' ));

--- drop tables
DROP TABLE IF EXISTS verify.no_name;